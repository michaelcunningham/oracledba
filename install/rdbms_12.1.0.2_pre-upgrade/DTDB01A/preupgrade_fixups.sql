REM Pre-Upgrade Script Generated on: 2016-03-07 16:14:05 
...
IF con_name = 'DTDB01' THEN
 
BEGIN
dbms_output.put_line ('Pre-Upgrade Fixup Script Generated on 2016-03-07 16:14:05  Version: 12.1.0.2 Build: 008');
dbms_output.put_line ('Beginning Pre-Upgrade Fixups...');
dbms_output.put_line ('Executing in container DTDB01');
END;
...
END;
/
REM Pre-Upgrade Script Closed At: 2016-03-07 16:14:11 
