REM Pre-Upgrade Script Generated on: 2016-03-08 10:35:47 
...
IF con_name = 'DEVTAGDB' THEN
 
BEGIN
dbms_output.put_line ('Pre-Upgrade Fixup Script Generated on 2016-03-08 10:35:47  Version: 12.1.0.2 Build: 008');
dbms_output.put_line ('Beginning Pre-Upgrade Fixups...');
dbms_output.put_line ('Executing in container DEVTAGDB');
END;
...
END;
/
REM Pre-Upgrade Script Closed At: 2016-03-08 10:35:55 
