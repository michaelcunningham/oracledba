REM Pre-Upgrade Script Generated on: 2016-03-08 10:21:51 
...
IF con_name = 'DWHSE' THEN
 
BEGIN
dbms_output.put_line ('Pre-Upgrade Fixup Script Generated on 2016-03-08 10:21:51  Version: 12.1.0.2 Build: 008');
dbms_output.put_line ('Beginning Pre-Upgrade Fixups...');
dbms_output.put_line ('Executing in container DWHSE');
END;
...
END;
/
REM Pre-Upgrade Script Closed At: 2016-03-08 10:21:58 
