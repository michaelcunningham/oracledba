...
# copied to.  This will be on the /tdcbackup2 volume.
...
#
#new_backup_qtree_name=${ORACLE_SID}_2009_03
target_backup_dir=/tdcbackup2/$new_backup_qtree_name
target_arch_dir=/tdcbackup2/$new_backup_qtree_name/arch
...
#
qtree_exists=`rsh $target_filer_name qtree status tdcbackup2 | grep $new_backup_qtree_name`
...
#
# rsh npnetapp104 ndmpcopy -sa root:fall2002 npnetapp103:/vol/tdcprd/.snapshot/monthend.1 npnetapp104:/vol/tdcbackup2/tdcprd_2009_april
