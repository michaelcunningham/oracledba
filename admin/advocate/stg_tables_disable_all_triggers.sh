...
log_file=$advocate_log_dir/stg_tables_disable_all_triggers_${ORACLE_SID}.log
stg_tables_list_file=$advocate_dir/stg_tables_list.txt
stg_tables_trigger_file=$advocate_dir/stg_tables_disable_all_triggers_.sql
...
do
  echo "alter table "$this_stg_table" disable all triggers;" >> $stg_tables_trigger_file
done
