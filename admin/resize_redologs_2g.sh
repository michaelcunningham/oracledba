...
alter database add logfile group 7 ( 
	'/redologs/${ORACLE_SID}/redo_${ORACLE_SID}_07a.redo',
...
alter database add logfile group 8 ( 
	'/redologs/${ORACLE_SID}/redo_${ORACLE_SID}_08a.redo',
...
alter database add logfile group 9 ( 
	'/redologs/${ORACLE_SID}/redo_${ORACLE_SID}_09a.redo',
...
alter database add logfile group 10 ( 
	'/redologs/${ORACLE_SID}/redo_${ORACLE_SID}_10a.redo',
...
alter database add logfile group ${current_group} ( 
	'/redologs/${ORACLE_SID}/redo_${ORACLE_SID}_${current_group_pad}a.redo',
