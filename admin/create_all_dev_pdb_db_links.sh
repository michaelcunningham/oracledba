...
begin
	create_db_link( 'DEVPDB01' );
	create_db_link( 'DEVPDB02' );
	create_db_link( 'DEVPDB03' );
	create_db_link( 'DEVPDB04' );
	create_db_link( 'DEVPDB05' );
	create_db_link( 'DEVPDB06' );
	create_db_link( 'DEVPDB07' );
	create_db_link( 'DEVPDB08' );
end;
/
