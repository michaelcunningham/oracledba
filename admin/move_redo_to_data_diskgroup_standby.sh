...
################################################################################
# Find the name of the DATA* diskgroup
################################################################################
...
begin
	...
	dbms_output.put_line( 'alter database recover managed standby database disconnect from session;' );
	dbms_output.put_line( '--------------------------------------------------------------------------------' );
end;
/
...
begin
	...
	dbms_output.put_line( 'alter database recover managed standby database cancel;' );
	dbms_output.put_line( '	' );
	s_sql := 'alter database clear logfile group ' || $current_group;
	dbms_output.put_line( s_sql || ';' );
	-- execute immediate s_sql;
