...
# copied to.  This will be on the /dwbackup2 volume.

#new_backup_qtree_name=${ORACLE_SID}_2009_07
...
then
  ...
  echo "Example: $0 dwprd monthend.1 dwprd_2009_xx"
  echo
  exit
else
  export ORACLE_SID=$1
...
# copied to.  This will be on the /dwbackup2 volume.
#
#new_backup_qtree_name=${ORACLE_SID}_2009_march
target_backup_dir=/dwbackup2/$new_backup_qtree_name
target_arch_dir=/dwbackup2/$new_backup_qtree_name/arch
...
#
qtree_exists=`rsh $target_filer_name qtree status dwbackup2 | grep $new_backup_qtree_name`
...
#
# rsh npnetapp104 ndmpcopy -sa root:fall2002 npnetapp103:/vol/dwprd/.snapshot/monthend.1 npnetapp104:/vol/dwbackup2/dwprd_2009_april
