...
log_file=$log_dir/run_sysstat_109.log
...
trigger_file=$perf_dir/sysstat_109.trg

# Check to see if the trigger file to run sysstats on npnetapp109 exists.
...
/dba/admin/filer_mon_sysstat.sh npnetapp109 10800

echo "Completed at: "`date` | mail -s "npnetapp109 sysstat report created" mcunningham@thedoctors.com
