...
jobname=dataguard_standby_archivelog-delete_stage-dev_${ORACLE_SID}
LOG_LOC=/mnt/dba/logs/$ORACLE_SID
log_file=$LOG_LOC/${ORACLE_SID}_${HOST}_dataguard_standby_archivelog-delete_stage-dev.log
...
# 2013-04-14: In case a DBA manually catalogs oralog2 for recovery, we cannot allow this job to 
# delete those logs from the standby.  Don't email any errors from this step.
rman target / << EOF >> $log_file 
change archivelog like '/mnt/oralogs/%' uncatalog;
change archivelog like '/mnt/db_transfer/%' uncatalog;
quit
EOF
