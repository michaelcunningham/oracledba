...
# copied to.  This will be on the /dwbackup volume.
...
target_backup_dir=/dwbackup/$new_backup_qtree_name
target_arch_dir=/dwbackup/$new_backup_qtree_name/arch
...
#
qtree_exists=`rsh $target_filer_name qtree status dwbackup | grep $new_backup_qtree_name`
...
#
# rsh npnetapp104 ndmpcopy -sa root:fall2002 npnetapp103:/vol/dwprd/.snapshot/monthend.1 npnetapp104:/vol/dwbackup/dwprd_2009_april
