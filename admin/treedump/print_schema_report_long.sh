...
log_file=$log_dir/treedump_long_${ORACLE_SID}_${username}_$log_date.log
...
exec treedump.print_schema_report( '$username' );
...
echo "$mail_message" | mutt -s "Index Treedump - "$ORACLE_SID swahby@thedoctors.com -a $log_file
