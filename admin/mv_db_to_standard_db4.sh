...
# export NEW_ORACLE_HOME=/oracle/app/oracle/product/10.2.0/db_4
#
...
# sed -i "s/db_1/db_4/g" ${NEW_ORACLE_HOME}/network/admin/tnsnames.ora
# sed -i "s/db_1/db_4/g" ${NEW_ORACLE_HOME}/network/admin/listener.ora
#
##########################################################################################
...
ln -s -f /oracle/app/oracle/admin/${ORACLE_SID}/pfile/init${ORACLE_SID}.ora /oracle/app/oracle/product/10.2.0/db_4/dbs/init${ORACLE_SID}.ora
