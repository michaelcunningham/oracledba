...
trace_detail=$4   # This can be a a longer description of the problem and maybe something to do about it
...
begin
	app_log_pkg.log_app_notification_prc( 'DBA',
		'$process_name', '$process_info', '$message_brief', '$trace_detail' );
end;
/
exit;
EOF
