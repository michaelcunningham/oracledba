...
alert_exclude="ORA-12012|ORA-00001|ORA-06512|kewrsp_split_partition|ORA-19815"
...
error_detected=`egrep -i "$alertlog_test" $alert_log_diff_filename | egrep -v $alert_exclude`
