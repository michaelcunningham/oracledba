...
alter database rename file '+DATA/${ORACLE_SID}/log01.ora' to '/u02/oradata/${ORACLE_SID}/redo/log01.ora';
alter database rename file '+DATA/${ORACLE_SID}/log02.ora' to '/u02/oradata/${ORACLE_SID}/redo/log02.ora';
alter database rename file '+DATA/${ORACLE_SID}/log03.ora' to '/u02/oradata/${ORACLE_SID}/redo/log03.ora';
alter database rename file '+DATA/${ORACLE_SID}/log04.ora' to '/u02/oradata/${ORACLE_SID}/redo/log04.ora';
alter database rename file '+DATA/${ORACLE_SID}/log05.ora' to '/u02/oradata/${ORACLE_SID}/redo/log05.ora';
alter database rename file '+DATA/${ORACLE_SID}/log06.ora' to '/u02/oradata/${ORACLE_SID}/redo/log06.ora';
alter database rename file '+DATA/${ORACLE_SID}/log07.ora' to '/u02/oradata/${ORACLE_SID}/redo/log07.ora';
alter database rename file '+DATA/${ORACLE_SID}/log08.ora' to '/u02/oradata/${ORACLE_SID}/redo/log08.ora';
alter database rename file '+DATA/${ORACLE_SID}/log09.ora' to '/u02/oradata/${ORACLE_SID}/redo/log09.ora';
alter database rename file '+DATA/${ORACLE_SID}/log10.ora' to '/u02/oradata/${ORACLE_SID}/redo/log10.ora';
